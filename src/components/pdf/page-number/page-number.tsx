...
import { View, Text as PDFText, StyleSheet } from '@/lib/pdf-primitives'
...
// LOCAL PATCH — see VENDORED.md. Removed dead `_formatPageNumber`: superseded by the
// `{page}`/`{total}` split below, referenced nowhere, and it broke `noUnusedLocals`.
