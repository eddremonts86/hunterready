...
export const Image = ({
  ...
  return (
    // LOCAL PATCH — see components/pdf/VENDORED.md. Upstream writes this as
    // `eslint-disable-next-line eslint(nextjs/no-img-element)`, which is not a valid rule
    // reference; ESLint hard-errors on the unknown rule. This project is not Next.js, so the
    // rule will never exist here. Comment kept as prose: PDF primitive, not a Next.js page.
    <img
      src={resolved}
