...
/**
 * Exported so `/v1/render-letter` calls this rather than restating it.
 *
 ...
 */
export async function renderLetterHandler({ request }: { request: Request }) {
